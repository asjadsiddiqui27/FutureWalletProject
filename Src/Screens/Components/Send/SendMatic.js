...
const fromAddress="0xD28F085D324A0e15A2Ac929435a0598f95efc517";
const privateKey="0x2e9a15175b88ca440b8c35c5c17e01930e8fe3d2d19b43acc69cc88a49945423"
const SendMatic = (props) => {
    ...
    const generateData = async () => {
        ...
        const maticBalance = await web3.eth.getBalance("0xD28F085D324A0e15A2Ac929435a0598f95efc517");
    ...
    return (
        <SafeAreaView style={[styles.main_container, { backgroundColor: themeColor.background }]}>
            ...
            <CustomHeader header="Send Matic" header_style={styles.header} headerimg={{ tintColor: themeColor.text }} onPress={() => { props.navigation.navigate("Send") }} />
            <SeperateLine />
                ...
                <View style={{ flex: 0.9 }}>
                    ...
                    <View style={{ flexDirection: 'row', justifyContent: "space-between", marginTop: dimen(12), marginBottom: dimen(36) }}>
                        ...
                        <View style={{ flexDirection: 'row' }}>
                            ...
                            <Text style={{ color: themeColor.text, fontSize: 14, fontFamily: fonts.PoppinsMedium }}>{maticbalance}</Text>
                        </View>
