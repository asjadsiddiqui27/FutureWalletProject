    ...
    <View style={styles.main_container}>
      <View style={styles.main_data_container}>
        ...
        <View style={styles.input_View}>
          <Text style={styles.input_label}>
            {Strings.English.importWallet.enteName}
          </Text>
        ...
        <View style={styles.data_View}>
          <View style={styles.secretPhrase_view}>
            <Text style={styles.secretPhrase_text}>
              {Strings.English.importWallet.secretPhrase}
            </Text>
          </View>
          <View style={styles.iconBtn_view}>
            <CustomBtnWIthIcon
              ...
              label={Strings.English.importWallet.Paste}
            />
          </View>
        </View>
        <View style={styles.oneLine_text_view}>
          <Text style={styles.oneLine_text}>
            {Strings.English.importWallet.middleText}
          </Text>
        </View>
      </View>
      <View style={styles.Bottom_main_continer}>
        ...
        <Text style={styles.bottom_text}>
          {Strings.English.importWallet.bottomText}
        </Text>
      </View>
    </View>
  );
